...
public class Crystal_SpecialAttack : StateMachineBehaviour
{
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        positions = GameObject.FindGameObjectsWithTag("PillarsOfLightPos");
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        if (Mathf.Round(distance) <= agent.stoppingDistance)
        {
            ...
            if (targetStats != null)
            {
                ...
                combat.BossAttack(targetStats, 50);
            }
    ...
    public void SpecialAttack()
    {
        ...
        {
            Instantiate(PillarPrefab, pos.transform.position, pos.transform.rotation);
        }
    }
}
